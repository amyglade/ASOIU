...
while (true)
{
    ...
    {
        Console.WriteLine("Ошибка: строки не могут быть null.\n");
        continue;
    }

    int distance = DamerauLevenshteinDistance.Distance(first, second);
    Console.WriteLine($"Расстояние Дамерау-Левенштейна между '{first}' и '{second}' равно {distance}\n");
}
